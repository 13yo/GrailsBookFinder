...
public class BibliographicStatusImpl implements BibliographicStatus {
    protected int item;
    protected String ibarcode;
    protected int bibno;
    protected boolean missing;
    protected boolean borrowed;
    protected ElectronicRight rights;
    ...
    public BibliographicStatusImpl(int item, String ibarcode, int bibno,
